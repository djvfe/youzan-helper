...
/**
 * kdt.item.update 修改一个商品请求参数
 * @author dj
 *
 */
public class ItemUpdateRequirement {
	/**
	 * 必须
	 * 商品数字编号
	 */
...
//	private byte[] images;
	...
	/**
	 * 编辑商品时保留商品已有图片，值为图片的id，多个图片id用逗号分隔。如果不传递该参数，则保留所有图片；如果为空，则删除所有图片
	 */
	private String keep_item_img_ids;
	/**
	...
	public String getKeep_item_img_ids() {
		return keep_item_img_ids;
	}
	public void setKeep_item_img_ids(String keepItemImgIds) {
		keep_item_img_ids = keepItemImgIds;
	}
