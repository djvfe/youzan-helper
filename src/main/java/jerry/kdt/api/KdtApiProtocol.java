...
public class KdtApiProtocol {
    ...
    public static String sign(String appSecret, HashMap<String,String>... paramesMaps){
    	HashMap<String,String> parames = new HashMap<String,String>();
    	if(paramesMaps!=null) {
    		for(HashMap<String,String> m : paramesMaps) {
    	    	if(m!=null&&!m.isEmpty()) parames.putAll(m);
    		}
    	}
